...
create_pct_change_table50 <- function(category, group, projections_all_sm, config, settings) {
  ...
  pct_change_table_df_high_low <- create_high_low_df50(pct_change_table_df, settings)
