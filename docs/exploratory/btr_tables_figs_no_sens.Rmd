...
```{r}
create_folders(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/by_gas_sector/"))
filename <- paste0("gas_table_",Sys.Date(),".html")
gtsave(gas_table_merged, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/by_gas_sector/",filename))
```
...
gtsave(sector_table_merged, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/by_gas_sector/",filename))
```
...
```{r}
create_folders(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/percent_change_2005/"))
filename <- paste0("gas_table_pctchange05_",Sys.Date(),".html")
gtsave(pct_change_html_gas_merged, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/percent_change_2005/",filename))
```
...
gtsave(pct_change_html_sector_merged, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/percent_change_2005/",filename))
```
...
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/btr_main_figs/main_fig/",filename), create.dir = TRUE, height = 5.5)
```
...
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/btr_main_figs/pct_change/",filename), create.dir = TRUE, height = 6)
```
...
#multipanel_kaya
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/kaya/kaya_multipanel.png"), width = 5, create.dir = TRUE)
...
singlepanel_kaya
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/kaya/kaya_singlepanel.png"), width = 5, create.dir = TRUE)
```
...
```{r}
buildings
ggsave(plot = buildings,filename = paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/sector_analysis/buildings_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
```
...
```{r}
electricity
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/sector_analysis/electricity_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
```
...
```{r}
transportation
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/sector_analysis/transportation_comparison",Sys.Date(),".png"), height = 4.5, width = 9)
```
...
```{r}
industry
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/sector_analysis/industry_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
```
...
```{r}
create_folders(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/ncbr_comparison/longnames/"))
filename <- paste0("ncbr_comp_table_",Sys.Date(),".html")
gtsave(ncbr_comp_table, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/ncbr_comparison/",filename))
```
...
```{r}
filename <- paste0("ncbr_comp_table_longnames",Sys.Date(),".html")
gtsave(ncbr_comp_table_longnames, paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/ncbr_comparison/longnames/",filename))
```

```{r}
tge_btr <- projections_all_sm %>% 
  filter(!gas == 'LULUCF Sink',
         grouping %in% c('wm','ghgi')) %>%
  group_by(proj_name, grouping, year) %>%
...
```{r}
fig <- ncbr_comparison_figure(ncbr_comp_ribbon, tge_all_long, settings, config, brvs = FALSE)
...
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/ncbr_comparison/",filename), create.dir = TRUE)
```
...
```{r}
filename <- paste0("ncbr_comp_fig_",Sys.Date(),".png")
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/ncbr_comparison/longnames/",filename), create.dir = TRUE)
```
...
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/results_tables/ncbr_comparison/",filename))
```
...
ggsave(paste0('output/',settings$version,"/exploratory/tables_figs_no_sens/nrg_emissions/",filename), create.dir = TRUE,height = 4.5)
```
...
ggsave(paste0('output/', settings$version, "/exploratory/tables_figs_no_sens/lulucf/", filename),
  create.dir = TRUE,
  height = 4.5,
  width = 9)
```
