...
```{r}
transportation
ggsave(transportation,paste0('output/',settings$version,"/tables_figs/sector_analysis/transportation_comparison",Sys.Date(),".png"), height = 4.5)
```
...
```{r}
industry
ggsave(industry, paste0('output/',settings$version,"/tables_figs/sector_analysis/industry_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5)
```
