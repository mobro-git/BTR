...
```{r}
btr_kaya <- kaya_comp_renamed %>%
  filter(br_version == '2024 BTR')
...
ggplot() +
  geom_ribbon(data = ribbon_df, mapping = aes(x = year, ymin = min, ymax = max, fill = variable, color = variable), alpha = .6) +
  theme_btr()
