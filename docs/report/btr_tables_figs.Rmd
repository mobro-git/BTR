...
```{r}
buildings
ggsave(plot = buildings,filename = paste0('output/',settings$version,"/tables_figs/sector_analysis/buildings_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5)
```
...
```{r}
electricity
ggsave(paste0('output/',settings$version,"/tables_figs/sector_analysis/electricity_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5)
```
...
```{r}
transportation
ggsave(paste0('output/',settings$version,"/tables_figs/sector_analysis/transportation_comparison",Sys.Date(),".png"), height = 4.5)
```
...
```{r}
industry
ggsave(paste0('output/',settings$version,"/tables_figs/sector_analysis/industry_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5)
```
