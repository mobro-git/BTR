...
---- need to add historical data for BR5 - 2022 GHGI through 2020
...
var_df_clean <- var_df %>%
  ...
  mutate(min = min(value),
         max = max(value)) %>%
  select(year, variable,unit, min, max) %>%
...
```{r}
var_list <-  c('Final Energy|Buildings|Residential|Biogas',
                                                             'Final Energy|Buildings|Residential|Biomass Liquids',
                                                             'Final Energy|Buildings|Residential|Biomass Solids',
                                                             'Final Energy|Buildings|Residential|Electricity',
                                                             'Final Energy|Buildings|Residential|Gas',
                                                             'Final Energy|Buildings|Residential|Hydrogen',
...
```{r}
var_list <-  c('Final Energy|Buildings|Commercial|Biogas',
                                                             'Final Energy|Buildings|Commercial|Biomass Liquids',
                                                             'Final Energy|Buildings|Commercial|Biomass Solids',
                                                             'Final Energy|Buildings|Commercial|Electricity',
                                                             'Final Energy|Buildings|Commercial|Gas',
                                                             'Final Energy|Buildings|Commercial|Hydrogen',
