...
fig
```
# TODO: Line break at 2022, geom_vline at 2022

```{r}
fig <- tge_breakout_figure(projections_ghgi)
fig
```

```{r}
fig <- tge_breakout_figure(projections_ghgi, gas_select = 'CH4', sector_select = 'Waste')
fig
```
```{r}
