...
```{r}
industry <- brvs_sens_sectors("Emissions|CO2|Energy|Demand|Transportation|Total", brvs_btr_subset = FALSE, brvs_sectors, ghgi_comp_tab, config, settings,data_long_clean)
