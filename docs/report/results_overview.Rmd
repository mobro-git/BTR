...
```{r}
sector = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 19, "United States", scenario_rename = TRUE)
sector
```
...
### Fuel
```{r}
fuel = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 14, "United States", scenario_rename = TRUE)
fuel
```

### Sector
```{r}
sector = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 17, "United States", scenario_rename = TRUE)
sector
```
...
### Buildings
```{r}
Buildings = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 8, "United States", scenario_rename = TRUE)
Buildings
```

### Industry
```{r}
Industry = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 9, "United States", scenario_rename = TRUE)
Industry
```

### Transportation
```{r}
Transportation = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 12, "United States", scenario_rename = TRUE)
Transportation
```
...
### Fuel
```{r}
Fuel = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 15, "United States", scenario_rename = TRUE)
Fuel
```
...
### Generation
```{r}
elec_gen = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 13, "United States", scenario_rename = TRUE)
elec_gen
```
...
### Capacity
```{r}
Capacity = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 3, "United States", scenario_rename = TRUE)
Capacity
```
...
### Generation
```{r}
elec_gen = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 6, "United States", scenario_rename = TRUE)
elec_gen
```
...
### Capacity
```{r}
Capacity = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 4, "United States", scenario_rename = TRUE)
Capacity
```
...
### Generation
```{r}
elec_gen = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 7, "United States", scenario_rename = TRUE)
elec_gen
```
...
### Capacity
```{r}
Capacity = print_graph("stacked_bar", config, data_long_clean, figmap_draftbriefing_stackbar, 5, "United States", scenario_rename = TRUE)
Capacity
```

---

# Final BTR Tables and Figures
