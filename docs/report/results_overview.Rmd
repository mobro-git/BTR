...
### Supply-Breakout
```{r}
model = print_graph("time_series", config, data_long_clean, figmap_nrgco2_timeseries, 10, "United States")
model
```
...
primary_energy_ffc <- print_graph("time_series", config, data_long_clean, figmap_nrgco2_timeseries, 6, "United States", scenario_rename = TRUE)
primary_energy_ffc
```
...
primary_energy_nonffc <- print_graph("time_series", config, data_long_clean, figmap_nrgco2_timeseries, 7, "United States", scenario_rename = TRUE)
primary_energy_nonffc
```
