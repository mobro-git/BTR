...
```{r}
sector = print_graph("stacked_bar", config, data_long_clean, figmap_nrgco2_stackbar, 18, "United States", scenario_rename = TRUE)
sector
```
...
# TODO: create projections figure that shows % reduction from 2005 instead of objective values
```