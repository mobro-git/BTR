...
lts_df = clean_data %>%
  filter(model %in% c("GCAM-LTS", "NEMS-OP-LTS")) %>%
...
proj_models = c("EPS-EI","GCAM-CGS","GCAM-PNNL","MARKAL-NETL","NEMS-OP","NEMS-RHG","REGEN-EPRI","RIO-REPEAT","USREP-ReEDS")
proj_df = clean_data %>%
...
# buildings
# savefig(buildings, "sector_compare_buildings")
# 
# # electricity
...
# electricity
# savefig(electricity, "sector_compare_electricity")
# 
# # transportation
...
# transportation
# savefig(transportation, "sector_compare_transportation")
# 
# # industry
...
# industry
# savefig(industry, "sector_compare_industry")
```
