...
gtsave(pct_change_html_gas_merged, paste0('output/',settings$version,"/tables_figs/to_2050/results_tables/percent_change_2005/",filename))
```
...
gtsave(pct_change_html_sector_merged, paste0('output/',settings$version,"/tables_figs/to_2050/results_tables/percent_change_2005/",filename))
```
