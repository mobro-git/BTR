...
gtsave(gas_table_merged, paste0('output/',settings$version,"/report/btr_published_deck/tables/Gas Table.html"))
```
...
gtsave(sector_table_merged, paste0('output/',settings$version,"/report/btr_published_deck/tables/Sector Table.html"))
```
