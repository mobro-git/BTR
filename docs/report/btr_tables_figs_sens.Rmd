...
data_long_clean_ind_fp <- data_long_clean %>% rbind(ghgi_ind_fp_df)

industry_and_fp <- section_pct_change_05(
...
industry_total <- section_pct_change_05(
  data_long_clean,
...
```{r}
industry_table <- create_stats_table(industry_and_fp)
industry_table
```
