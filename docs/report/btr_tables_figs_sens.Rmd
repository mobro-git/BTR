...
ggsave(plot = buildings,filename = paste0('output/',settings$version,"/tables_figs_sens/sector_analysis_ribbons/buildings_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
```
...
ggsave(paste0('output/',settings$version,"/tables_figs_sens/sector_analysis_ribbons/electricity_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
...
ggsave(paste0('output/',settings$version,"/tables_figs_sens/sector_analysis_ribbons/transportation_comparison",Sys.Date(),".png"), height = 4.5, width = 9)
...
ggsave(paste0('output/',settings$version,"/tables_figs_sens/sector_analysis_ribbons/industry_comparison",Sys.Date(),".png"), create.dir = TRUE, height = 4.5, width = 9)
