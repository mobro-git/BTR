---
pagetitle: "Projections Update CCD"
output:
  html_document:
...
multipanel_kaya
ggsave(paste0('output/',settings$version,"/tables_figs/kaya/kaya_multipanel.png"), width = )
...
singlepanel_kaya
ggsave(paste0('output/',settings$version,"/tables_figs/kaya/kaya_singlepanel.png"), width = )
```
