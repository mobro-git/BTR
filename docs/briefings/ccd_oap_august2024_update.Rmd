...
```{r}
fig <- ncbr_comparison_figure(ncbr_comp_ribbon_with_brvs, tge_all_long_with_brvs, settings, config, brvs = TRUE, brvs_name = "2023 BR Voluntary Supplement - All Models")
fig
```
